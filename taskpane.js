      ...
      paragraphs.items.forEach((p, idx) => {
        ...
        switch (role) {
          ...
          case "CO_QUAN_BAN_HANH":
            // Cơ quan ban hành: in hoa, đứng, ĐẬM, gạch chân bằng chữ (đã thử bảng lồng để có
            // viền đẹp hơn nhưng Word báo lỗi "Column widths cannot be less than 1.27 cm" do ô
            // chứa quá hẹp — không khả thi, giữ cách an toàn này).
          ...
          case "TIEU_NGU":
            // Tiêu ngữ: đậm, canh giữa, gạch chân bằng chữ (đã thử OOXML và bảng lồng nhưng đều
            // gặp lỗi tương thích trong môi trường Word thực tế — giữ cách an toàn, luôn chạy được)
